...
export default function MovieList({
  ...
  const [isitsee, setIsitsee] = useState(false);
  ...
  return (
    <section className="container py-4">
      <header className="d-flex align-items-center justify-content-between mb-3">
        ...
        <Filter isitsee={isitsee} setIsitsee={setIsitsee} onSelectCategory={filteredmovie}/>
      </header>

      {filteredmovies.length == 0  ? (
        <h2 className="alert alert-danger text-center">Filmlere Ulaşılamıyor</h2>
      ): (
        <>
          <div
            id="movie-list"
            ...
            <div className="row">
              <div className="col-lg-6">
                <button
                  ...
                  onClick={() => lowerPages(pages--)}
                >
                  <i class="fa-solid fa-caret-left"></i>
                </button>
              </div>
              <div className="col-lg-5">{pages}</div>
              <div className="col-lg-1">
                <button
                  className="btn btn-outline-warning"
                  onClick={() => upperPages(pages++)}
                >
